...
const headCells = [
  ...
  {
    id: 'feeAmount', numeric: true, disablePadding: false, label: 'feeAmount',
  },
  {
    id: 'userCount', numeric: true, disablePadding: false, label: 'userCount',
  },
  {
