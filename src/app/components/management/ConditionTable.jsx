...
import RemoveConditionKeyDialog from './RemoveConditionKeyDialog';
...
const headCells = [
  ...
  {
    id: 'currentHealth', numeric: true, disablePadding: false, label: 'Current Health',
  },
  {
    id: 'currentMana', numeric: true, disablePadding: false, label: 'Current Mana',
  },
  {
    id: 'currentStamina', numeric: true, disablePadding: false, label: 'Current Stamina',
  },
  {
    ...
    <Root className={classes.root}>
      <TableContainer>
        <Table className={classes.table} aria-labelledby="tableTitle" size={dense ? 'small' : 'medium'} aria-label="enhanced table">
          ...
          <TableBody>
            {stableSort(conditionRecords, getComparator(order, orderBy))
              ...
              .map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="right">{row.currentHealth}</TableCell>
                    <TableCell align="right">{row.currentMana}</TableCell>
                    <TableCell align="right">{row.currentStamina}</TableCell>
                    <TableCell align="right">{row.ttl}</TableCell>
                    <TableCell align="right">
                      <RemoveConditionKeyDialog
                        conditionKey={row.key}
                        confirmRemoveConditionKey={removeConditionKey}
                      />
                    </TableCell>
...
ConditionTable.propTypes = {
  conditionRecords: PropTypes.array.isRequired,
  removeConditionKey: PropTypes.func.isRequired,
